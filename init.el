...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-ivy lsp-treemacs lsp-ui lsp-mode which-key visual-fill-column use-package rainbow-delimiters python-mode org-bullets general evil eshell-git-prompt doom-themes doom-modeline counsel-projectile)))
(custom-set-faces
